...
app.use('/api/venues', createVenueRoutes(store));
app.use('/api/invoices', createInvoiceRoutes(store));
app.use('/api/recipes', createRecipeRoutes(store));
app.use('/api/recipe-drafts', createRecipeDraftRoutes(getDb()));
app.use('/api/recipe-intelligence', createRecipeIntelligenceRoutes(getDb()));
app.use('/api/recipe-templates', createRecipeTemplateRoutes(getDb()));
